...
EQAudioProcessor::EQAudioProcessor() : parameterManager(EQParams().createParams(), *this) {
    // ============================================================================
...
const juce::String EQAudioProcessor::getProgramName(int) {
    return {};
}
