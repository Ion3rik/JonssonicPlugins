...
SVFDemoAudioProcessorEditor::SVFDemoAudioProcessorEditor(SVFDemoAudioProcessor& p)
    : AudioProcessorEditor(p), audioProcessor(p), controlPanelConfig([] {
          ...
          c.subtitle = "SVFDEMO"; // Plugin subtitle
...
SVFDemoAudioProcessorEditor::~SVFDemoAudioProcessorEditor() {
    setLookAndFeel(nullptr); // Reset the look and feel to default
    customLookAndFeel.reset();
}

//==============================================================================
void SVFDemoAudioProcessorEditor::paint(juce::Graphics& g) {
...
void SVFDemoAudioProcessorEditor::resized() {
