...
BiquadDemoAudioProcessor::BiquadDemoAudioProcessor()
    : parameterManager(BiquadDemoParams::createParams(), *this)
{
// ============================================================================
...
// ============================================================================
    ...
    parameterManager.on(ID::FilterType, [this](int value, bool skipSmoothing) {
        biquadFilter.setType(static_cast<Jonssonic::BiquadType>(value));
...
//==============================================================================
const juce::String BiquadDemoAudioProcessor::getName() const { return JucePlugin_Name; }
bool BiquadDemoAudioProcessor::producesMidi() const { return false; }
bool BiquadDemoAudioProcessor::isMidiEffect() const { return false; }
double BiquadDemoAudioProcessor::getTailLengthSeconds() const { return 0.0; }
int BiquadDemoAudioProcessor::getNumPrograms() { return 1; }
int BiquadDemoAudioProcessor::getCurrentProgram() { return 0; }
void BiquadDemoAudioProcessor::setCurrentProgram(int) { }
const juce::String BiquadDemoAudioProcessor::getProgramName(int) { return {}; }
void BiquadDemoAudioProcessor::changeProgramName(int, const juce::String&) { }
bool BiquadDemoAudioProcessor::hasEditor() const { return true; }
juce::AudioProcessorEditor* BiquadDemoAudioProcessor::createEditor() { return new BiquadDemoAudioProcessorEditor(*this); }
//==============================================================================
